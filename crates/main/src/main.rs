...
fn render_genome2_to_lilypond(genome: &GrammarDerivationGenome2, time_signature: TimeSignature, output_path: &str) {
    ...
    let music_string = genome.0.to_music_string();
...
fn experiment_2(trials: usize) {
    ...
    for trial in 0..trials {
        ...
        render_genome2_to_lilypond(best_genome, grammar.time_signature, &ly_path);
