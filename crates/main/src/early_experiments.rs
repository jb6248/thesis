...
use crate::genetic_simulation::{GrammarDerivationGenome, Simulation};
...
fn experiment_2(trials: usize) {
    ...
    for trial in 0..trials {
        ...
        crate::render_grammar_derivation_to_lilypond(&best_genome.0, grammar.time_signature, &ly_path);
...
fn template_5(trials: usize, distance_bias: f64, experiment_location: &str) {
    // this uses hierarchical analysis of prolongational trees
    // --- constants ---
    let grammar_file    = &format!("{experiment_location}/grammar.mt");
    let population_size   = 100;
